...
rate.forEach((rate, idx) => {
  rate.addEventListener('click', () => {
    document
      .querySelector('button.rate:nth-child(1)')
      .classList.remove('active');
    document
      .querySelector('button.rate:nth-child(2)')
      .classList.remove('active');
    document
      .querySelector('button.rate:nth-child(3)')
      .classList.remove('active');
    document
      .querySelector('button.rate:nth-child(4)')
      .classList.remove('active');
    document
      .querySelector('button.rate:nth-child(5)')
      .classList.remove('active');
